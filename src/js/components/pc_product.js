            ...
            <div className="mod_r_product" ne-module="modules/product/product.js">
                <div className="cm_mod_tab cm_mod_tab1 mod_all_product">
                    <div className="tab_nav">
                        ...
                        <a href="javascript:;" ne-click="productAll()" className="more more_open" ne-text="{{myState.openProduct ? '返回':'全部产品'}}" target="_self">返回</a>
                    </div>
                    <div className="tab_main login_tabmain">
                        {/* 网易新闻 */}
                        ...
                        <div className="cell clearfix cell_email">
                            ...
                            <div className="detail">
                                <h3><a href="http://entry.mail.163.com/coremail/fcg/ntesdoor2?verifycookie=1&lightweight=1&from=urs">网易邮箱</a></h3>
                                <div className="y_login">
                                    未读邮件:
                                    <a href="http://entry.mail.163.com/coremail/fcg/ntesdoor2?verifycookie=1&lightweight=1&from=urs" className="fontred mailnum" target="_blank" ne-href="{{myState.loginmail}}">
                                        9
                                    </a>
                                    积分:
                                    ...
                                    <a href="http://entry.mail.163.com/coremail/fcg/ntesdoor2?verifycookie=1&lightweight=1&from=urs&ntes_mail_firstpage=compose" className="go_pro go_writemail" target="_blank" ne-href="{{myState.loginmail}}&ntes_mail_firstpage=compose"><span>写邮件</span></a>
                                </div>
                        ...
                        <div className="cell cell_app">
                            {/* 前三个位置随机，最后一个位置固定 */}
                            <ul id="app_list">
                                <li className="bohe_app"><a href="http://live.ent.163.com/download?f=163.homeMyApp"><i /><span>网易薄荷</span></a></li><li className="gongkaike_app"><a href="http://open.163.com/appdownload/mobile?news_other"><i /><span>公开课</span></a></li><li className="bolo_app"><a href="http://bolo.163.com"><i /><span>网易菠萝</span></a></li><li className="hongcai_app"><a href="https://hongcai.163.com/?from=pcsy-button"><i /><span>网易红彩</span></a></li></ul>
                            ...
                            <ul className="clearfix">
                                ...
                                <li>
                                    <h3>
                                        ...
                                        <a href="http://sky.163.com/">Sky光遇</a>
                                    </h3>
